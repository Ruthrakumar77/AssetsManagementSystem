...
export const EmployeeEditModel = ({ handleModelClose, editEmployee }) => {
    ...
    async function handleSaveChanges(event) {
        ...
        if (isEdit) {
            try {
                await axios.put("http://localhost:8080/api/v1/user/edit/employee", employeeDetails,
                    { withCredentials: true, headers: { userid: employeeDetails._id } })
                handleModelClose()
            } catch (error) {
                console.log(error)
            }
            ...
            try {
                await axios.post("http://localhost:8080/api/v1/user/add/employee", employeeDetails,
                            ...
                            <div className="grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="number" name="mobile" id="mobile" className="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required=""
                                        onChange={onChangeHandler} value={employeeDetails.mobile ? employeeDetails.mobile : ""} />
                                </div>
                                <div className="col-span-6 sm:col-span-3">
